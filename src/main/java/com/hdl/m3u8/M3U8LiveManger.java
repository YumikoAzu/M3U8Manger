...
public class M3U8LiveManger {
    ...
    private void startDownloadM3U8() {
        ...
        for (final M3U8Item m3U8Ts : m3U8TsList) {
...
//                                    e.printStackTrace();
     ...
     * 请求到的所有下载列表
     */
    private List<M3U8Item> m3U8TsList = new ArrayList<>();
...
//                            Log.e("hdltag", "run(M3U8LiveManger.java:59):" + m3u8);
     ...
     * @param tsList
     */
    private synchronized void addTs(List<M3U8Item> tsList) {
        List<M3U8Item> tempTsList = new ArrayList<>();
        for (M3U8Item m3U8Ts : tsList) {
            boolean isExisted = false;
            for (M3U8Item mTs : m3U8TsList) {
        ...
        for (M3U8Item m3U8Ts : m3U8TsList) {
